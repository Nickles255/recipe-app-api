...
class AdminSiteTests(TestCase):
    ...
    def test_users_listed(self):
        ...
        # Check that the user's email is in the response
        self.assertContains(res, self.user.email)

    def test_edit_user_page(self):
        """Test that the edit user page works."""
        # Get the URL for the edit user page in the admin
        url = reverse("admin:core_user_change", args=[self.user.id])
        # Make a GET request to the edit user page
    ...
    def test_create_user_page(self):
        ...
        # Get the URL for the create user page in the admin
